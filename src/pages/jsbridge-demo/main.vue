<template>
  <div class="container">
    ...
    <button class="weui-btn weui-btn_default" @click="test_close">关闭窗口type1</button>
    <button class="weui-btn weui-btn_default" @click="test_close_2">关闭窗口type2</button>
    ...
    <button class="weui-btn weui-btn_default" @click="test_navtouri">跳转（navToUri）</button>
    <button class="weui-btn weui-btn_default" @click="test_share">分享</button>
  </div>
</template>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      test_close_2 () {
        bridge.close({type: '2'}, function (cb) {
          window.alert(cb.ret)
        })
      },
      test_openuri () {
        bridge.openUri({
          uri: 'https:wx.qa.qfpay.net/near-v2/jsbridge-demo.html'
        }, function (cb) {
          window.alert(cb.ret)
        })
      },
