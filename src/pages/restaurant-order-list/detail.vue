  ...
  <div class="detail-all-box">
    <div class="detail-box">
      ...
      <div class="qucan-id-wrap">
        <p class="color-gray font-30">取餐号：<span class="color-weight font-44">{{orderinfo.order_sn}}</span></p>
        <p class="color-orange font-44 text-right">{{orderinfo.address}}号桌</p>
      </div>
    </div>
    <ul>
      ...
      <div class="detail-total-box">
        <div class="detail-list-total">
          <p class="color-weight font-34 ">总价</p>
    ...
    <div class="order-info-wrap">
      <p class="color-gray font-30 margin-14">订单编号：{{orderinfo.order_id}}</p>
      <p class="color-gray font-30 margin-14">购买时间：{{orderinfo.pay_time | formatTime "yyyy-MM-dd hh:mm:ss"}}</p>
      <p class="color-gray font-30 margin-14">交易号：{{orderinfo.syssn}}</p>
    </div>
  </div>
  <div class="print-btn">
    <a @click="print(orderId)" class="list-btn font-30 color-orange">打印小票</a>
  </div>
</template>
